...
class Order(Base, TimestampMixin):
    ...
    original_price: Mapped[int | None] = mapped_column(Integer, nullable=True, comment='折前原价，无折扣时为空')
    discount_amount: Mapped[int | None] = mapped_column(Integer, nullable=True, comment='优惠减免金额')
    coupon_code: Mapped[str | None] = mapped_column(String(64), nullable=True, comment='使用的积分商城券码')
